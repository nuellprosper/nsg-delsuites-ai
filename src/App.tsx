...
/**
 * NSG (Nuell Study Guide) V3.5 - EXECUTIVE EDITION
      ...
      <header className="px-5 py-4 flex justify-between items-center border-b border-slate-200 dark:border-white/10 bg-white/80 dark:bg-[#050505]/95 backdrop-blur-xl sticky top-0 z-40">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <span className="text-[9px] font-black text-slate-400 dark:text-white/40 uppercase tracking-widest">Lecture OS 3.5</span>
          </div>
        </div>
        <div className="flex items-center gap-3">
              ...
              <div className="bg-white dark:bg-[#0a0a0a] rounded-3xl p-8 border border-slate-200 dark:border-white/10 relative overflow-hidden shadow-sm">
                <div className="flex flex-col items-center text-center relative z-10">
                  ...
                  <div className="flex gap-2 w-full max-w-xs">
                    {audioUrl && (
                      <a href={audioUrl} download="NSG_Lecture.mp3" className="flex-1 flex items-center justify-center gap-2 bg-slate-200 dark:bg-white/10 hover:bg-slate-300 dark:hover:bg-white/20 text-slate-900 dark:text-white px-4 py-3 rounded-2xl text-xs font-bold transition-all">
